...
macro(project_setup_options)
  ...
  option(project_PACKAGING_MAINTAINER_MODE "Enable maintainer mode" OFF)
  ...
  project_check_libfuzzer_support(LIBFUZZER_SUPPORTED)
  if(LIBFUZZER_SUPPORTED AND (project_ENABLE_SANITIZER_ADDRESS OR project_ENABLE_SANITIZER_THREAD OR project_ENABLE_SANITIZER_UNDEFINED))
    set(DEFAULT_FUZZER ON)
  else()
    set(DEFAULT_FUZZER OFF)
  endif()

  option(project_BUILD_FUZZ_TESTS "Enable fuzz testing executable" ${DEFAULT_FUZZER})
...
macro(project_global_options)
  ...
  if(project_ENABLE_HARDENING AND project_ENABLE_GLOBAL_HARDENING)
    ...
    message("${project_ENABLE_HARDENING} ${ENABLE_UBSAN_MINIMAL_RUNTIME} ${project_ENABLE_SANITIZER_UNDEFINED}")
...
macro(project_local_options)
  ...
  if(project_ENABLE_PCH)
    target_precompile_headers(
      ...
      <string>
      <utility>
      "$<$<COMPILE_LANGUAGE:CXX>:${CMAKE_CURRENT_SOURCE_DIR}/include/hikari/Core/Logger.hpp>"
      "$<$<COMPILE_LANGUAGE:CXX>:${CMAKE_CURRENT_SOURCE_DIR}/src/hikari/Core/Assert.hpp>"
